...
export const HomePage = () => {
  return (
 <div className=' for'>
  <h1 classname="inicio">Tarea para hoy</h1>
  <div>
    <p className='parrafo'>No mires asi atras con ira, ni hacia adelante con miedo, sino alrededor con atencion, aquella hermosa magia libra mil batallas si luchas por tus sueños y te arriesgas. 
